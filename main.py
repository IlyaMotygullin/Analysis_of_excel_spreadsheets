...
def save_formattd_excel(excel_obj: pd.ExcelFile, sheet_name: str, dict_date_coordinate: dict, date_mapping: dict, output_path: str = None):
...
if isinstance((found1, found2), datetime):
